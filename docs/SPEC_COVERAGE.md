...
| RFC8620 | [5.2](https://www.rfc-editor.org/rfc/rfc8620.html#section-5.2) | `MUST` | calculate an intermediate state, it MUST return a | ✅ Covered | `TestRFC8620_Section5_6_QueryChangesOrderAndCannotCalculate` | Extracted by specextract from RFC8620 §5.2 [p12] |
