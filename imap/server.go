...
// TestServer wraps an in-process IMAP test server.
...
// NewTestServer creates an in-process IMAP server with pre-provisioned users.
func NewTestServer(usernames ...string) (*TestServer, func()) {
	if len(usernames) == 0 {
