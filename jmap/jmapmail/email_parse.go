...
func ParseRFC822(raw []byte, blobBackend ...jmapblob.BlobBackend) (*Email, error) {
...
func parseRFC822WithAccount(accountID string, raw []byte, blobBackend ...jmapblob.BlobBackend) (*Email, error) {
...
func parseMIMEEntity(ctx context.Context, accountID string, e *message.Entity, depth int, partCounter *int, bodyValues map[string]EmailBodyValue, bb jmapblob.BlobBackend) (EmailBodyPart, error) {
...
// ExtractBodyStructureParts extracts textBody, htmlBody, and attachments from the root body structure.
