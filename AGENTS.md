...
3. **Segregated Non-Mail Stores**: Non-mail domains (calendars, contacts/cards, sieve, filenodes) maintain isolated store implementations under `jmap/testmock/` to allow full protocol verification without coupling to email storage.
